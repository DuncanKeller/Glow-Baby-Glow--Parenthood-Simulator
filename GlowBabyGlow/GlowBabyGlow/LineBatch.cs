...
namespace GlowBabyGlow
{
    ...
    static public class LineBatch
    {
        ...
        static public void DrawLineSkinny(SpriteBatch batch, Color color,
                                   Vector2 point1, Vector2 point2)
        {
            DrawLineSkinny(batch, color, point1, point2, 0);
        }
        ...
        static public void DrawLineSkinny(SpriteBatch batch, Color color, Vector2 point1,
                                  Vector2 point2, float Layer)
        {
            //Check if data has been set for texture
            //Do this only once otherwise
